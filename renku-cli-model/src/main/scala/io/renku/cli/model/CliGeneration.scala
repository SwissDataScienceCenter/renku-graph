...
object CliGeneration {
  ...
  object GenerationEntity {
    final case class Entity(entity: CliSingleEntity) extends GenerationEntity {
    ...
    def apply(entity: CliSingleEntity):           GenerationEntity = Entity(entity)
    ...
    implicit def jsonLDDecoder: JsonLDDecoder[GenerationEntity] = {
      val da = CliSingleEntity.jsonLDDecoder.emap(e => Right(GenerationEntity(e)))
