...
import ch.datascience.commiteventservice.commits.CommitInfo
import ch.datascience.commiteventservice.eventprocessing.CommitEvent.{NewCommitEvent, SkippedCommitEvent}
import ch.datascience.commiteventservice.eventprocessing._
...
private object Generators {
  ...
  private[commitsync] implicit lazy val commitSyncEvents: Gen[CommitSyncEvent] = for {
    commitId       <- commitIds
    projectId      <- projectIds
