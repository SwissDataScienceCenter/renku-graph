...
private trait DequeuedEventHandler[F[_]] extends DBUpdater[F, ProjectEventsToNew]
...
private class DequeuedEventHandlerImpl[F[_]: Async: Logger: QueriesExecutionTimes](
