...
import ch.datascience.eventlog.statuschange.commands.ProjectPathFinder.findProjectPath
import ch.datascience.eventlog.{EventLogDB, EventMessage, EventStatus}
...
final case class ToRecoverableFailure[Interpretation[_]](
  ...
  override def updateGauges(
    ...
    case UpdateResult.Updated => findProjectPath(eventId) flatMap waitingEventsGauge.increment
    case _                    => ME.unit
  }
}
