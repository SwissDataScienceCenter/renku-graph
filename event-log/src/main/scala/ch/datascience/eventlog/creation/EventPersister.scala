...
package ch.datascience.eventlog.creation
...
import ch.datascience.eventlog.EventStatus.{New, Processing, RecoverableFailure}
import ch.datascience.eventlog.TypesSerializers._
import ch.datascience.eventlog.{Event, EventLogDB, EventStatus}
