...
import ch.datascience.eventlog.creation.{EventCreationEndpoint, EventPersister}
import ch.datascience.eventlog.latestevents.{LatestEventsEndpoint, LatestEventsFinder}
import ch.datascience.eventlog.processingstatus.{ProcessingStatusEndpoint, ProcessingStatusFinder}
import ch.datascience.eventlog.rescheduling.ReSchedulingEndpoint
import ch.datascience.eventlog.statuschange.{StatusChangeEndpoint, StatusUpdatesRunner}
import ch.datascience.eventlog.subscriptions.{Subscriptions, SubscriptionsEndpoint}
