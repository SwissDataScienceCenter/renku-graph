...
import ch.datascience.eventlog.EventStatus.NonRecoverableFailure
import ch.datascience.eventlog.statuschange.StatusUpdatesRunner
import ch.datascience.eventlog.statuschange.commands.{ToNonRecoverableFailure, UpdateResult}
import ch.datascience.eventlog.subscriptions.EventsSender.SendingResult
import ch.datascience.eventlog.subscriptions.EventsSender.SendingResult._
import ch.datascience.eventlog.{Event, EventMessage}
