...
import io.renku.graph.model.entities.{CompositePlan, Plan, Project, StepPlan}
...
private object OntologyGenerator {
  private val types =
    NonEmptyList.of(Project.ontology, Plan.ontology, CompositePlan.Ontology.typeDef, StepPlan.ontology)
