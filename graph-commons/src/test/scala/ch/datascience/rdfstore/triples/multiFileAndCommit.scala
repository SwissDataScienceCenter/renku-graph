...
object multiFileAndCommit {
  ...
  private val commit1Id = CommitId("0000001")
  private val commit2Id = CommitId("0000002")
  private val commit3Id = CommitId("0000003")
  val commit4Id: CommitId = CommitId("0000004")
  private val commit1DatasetGenerationId =
    GenerationActivity.Id(commit1Id, FilePath("tree/.renku/refs/datasets/zhbikes"))
  private val commit1ActivityId                  = CommitActivity.Id(commit1Id)
  private val commit1CollectionEntityId          = CommitCollectionEntity.Id(commit1Id, FilePath("input-data"))
  private val commit2ActivityId                  = CommitActivity.Id(commit2Id)
  private val commit2Source1GenerationId         = GenerationArtifact.Id(commit2Id, FilePath("source-file-1"))
  private val commit2Source2GenerationId         = GenerationArtifact.Id(commit2Id, FilePath("source-file-2"))
  private val commit2Source1GenerationActivityId = GenerationActivity.Id(commit2Id, FilePath("tree/source-file-1"))
  private val commit2Source2GenerationActivityId = GenerationActivity.Id(commit2Id, FilePath("tree/source-file-2"))
  private val commit3ActivityId                  = CommitActivity.Id(commit3Id)
  private val commit3PreprocessedGenerationId    = GenerationArtifact.Id(commit3Id, FilePath("preprocessed-data"))
  private val commit3Output0GenerationId         = CommitGeneration.Id(commit3Id, FilePath("outputs/output_0"))
  private val commit3AssociationActivityId       = AssociationActivity.Id(commit3Id)
  private val commit3Input1UsageEntityId         = UsageEntity.Id(commit3Id, FilePath("inputs/input_1"))
  private val commit3Input2UsageEntityId         = UsageEntity.Id(commit3Id, FilePath("inputs/input_2"))
  private val commit4AssociationActivityId       = AssociationActivity.Id(commit4Id)
  private val commit4Input1UsageEntityId         = UsageEntity.Id(commit4Id, FilePath("inputs/input_1"))
  private val commit4Input2UsageEntityId         = UsageEntity.Id(commit4Id, FilePath("inputs/input_2"))
  private val commit4Output0GenerationId         = GenerationActivity.Id(commit4Id, FilePath("outputs/output_0"))
  private val commit4Output1GenerationId         = GenerationActivity.Id(commit4Id, FilePath("outputs/output_1"))
  private val commit4File1GenerationId           = GenerationArtifact.Id(commit4Id, resultFile1)
  private val commit4File2GenerationId           = GenerationArtifact.Id(commit4Id, FilePath("result-file-2"))
  // format: off
