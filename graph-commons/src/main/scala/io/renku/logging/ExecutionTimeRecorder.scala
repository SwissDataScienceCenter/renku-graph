...
class ExecutionTimeRecorder[Interpretation[_]: Sync: Clock: Logger](threshold: ElapsedTime,
...
object ExecutionTimeRecorder {
  ...
  } yield new ExecutionTimeRecorder(ElapsedTime(duration), maybeHistogram)
