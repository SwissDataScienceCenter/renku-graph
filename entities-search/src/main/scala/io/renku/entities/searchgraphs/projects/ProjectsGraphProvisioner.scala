...
object ProjectsGraphProvisioner {
  def apply[F[_]: Async: Logger: SparqlQueryTimeRecorder](
    ...
    new ProjectsGraphProvisionerImpl[F]()
  }
}

private class ProjectsGraphProvisionerImpl[F[_]: MonadThrow] extends ProjectsGraphProvisioner[F] {
  override def provisionProjectsGraph(project: Project): F[Unit] = ().pure[F]
}
