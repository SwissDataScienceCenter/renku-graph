...
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.datasets.{DataSetInfoEnricher, IODataSetInfoEnricher}
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.forks.{ForkInfoUpdater, IOForkInfoUpdater}
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.persondetails.PersonDetailsUpdater
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.CurationResults
...
private[awaitinggeneration] object IOTriplesCurator {
