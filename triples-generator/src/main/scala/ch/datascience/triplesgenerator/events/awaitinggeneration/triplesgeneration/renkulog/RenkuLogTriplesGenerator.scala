...
package ch.datascience.triplesgenerator.events.awaitinggeneration.triplesgeneration.renkulog
...
import ch.datascience.triplesgenerator.events.awaitinggeneration.CommitEvent._
...
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplesgeneration.renkulog.Commands.{GitLabRepoUrlFinder, RepositoryPath}
