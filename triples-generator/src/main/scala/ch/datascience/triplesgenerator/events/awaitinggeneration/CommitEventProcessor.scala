...
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.{IOTriplesCurator, TriplesCurator}
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplesgeneration.GenerationResult._
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplesgeneration.TriplesGenerator
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplesuploading.TriplesUploadResult._
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplesuploading.{IOUploader, TriplesUploadResult, Uploader}
