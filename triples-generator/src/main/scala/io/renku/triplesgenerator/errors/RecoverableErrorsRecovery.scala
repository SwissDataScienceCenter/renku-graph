...
import ProcessingNonRecoverableError.MalformedRepository
...
trait RecoverableErrorsRecovery {
...
object RecoverableErrorsRecovery extends RecoverableErrorsRecovery
