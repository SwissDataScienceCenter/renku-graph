...
package ch.datascience.triplesgenerator.events.categories.awaitinggeneration.triplesuploading
...
import ch.datascience.triplesgenerator.events.categories.awaitinggeneration.triplesuploading.TriplesUploadResult.{DeliverySuccess, InvalidUpdatesFailure, RecoverableFailure}
