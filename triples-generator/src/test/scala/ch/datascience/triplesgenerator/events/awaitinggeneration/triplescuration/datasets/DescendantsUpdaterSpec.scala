...
package ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.datasets
...
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.CuratedTriples
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.CurationGenerators.curatedTriplesObjects
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplescuration.datasets.TopmostDataFinder.TopmostData
