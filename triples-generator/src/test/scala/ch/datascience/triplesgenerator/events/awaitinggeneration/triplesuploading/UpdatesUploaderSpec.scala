...
package ch.datascience.triplesgenerator.events.awaitinggeneration.triplesuploading
...
import ch.datascience.triplesgenerator.events.awaitinggeneration.triplesuploading.TriplesUploadResult.{DeliverySuccess, InvalidUpdatesFailure, RecoverableFailure}
