...
import ch.datascience.triplesgenerator.events.categories.awaitinggeneration.triplescuration.{CuratedTriples, TriplesCurator}
...
import ch.datascience.triplesgenerator.events.categories.awaitinggeneration.triplesuploading.TryUploader
