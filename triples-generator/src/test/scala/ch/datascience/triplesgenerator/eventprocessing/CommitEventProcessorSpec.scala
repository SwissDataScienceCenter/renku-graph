...
//import ch.datascience.triplesgenerator.eventprocessing.triplescuration.{CuratedTriples, GraphCurator, TriplesCurator}
...
//    val graphCurator          = mock[GraphCurator[Try]]
