...
import CategoryGenerators.minProjectInfoEvents
import cats.syntax.all._
import io.renku.generators.Generators.Implicits._
import org.scalatest.matchers.should
import org.scalatest.wordspec.AnyWordSpec

class MinProjectInfoEventSpec extends AnyWordSpec with should.Matchers {

  "show" should {
    "return String representation of the underlying Project" in {
      val event = minProjectInfoEvents.generateOne
      event.show shouldBe event.project.show
    }
  }
}
