...
package ch.datascience.commitgraphgenerator.events.categories.awaitinggeneration.subscriptions
...
import ch.datascience.commitgraphgenerator.events.categories.awaitinggeneration.GenerationProcessesNumber
