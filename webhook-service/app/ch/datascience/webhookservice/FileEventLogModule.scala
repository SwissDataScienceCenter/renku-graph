...
import ch.datascience.webhookservice.eventprocessing.commitevent.{EventLog, FileIOEventLog}
...
class FileEventLogModule(environment: Environment, configuration: Configuration) extends AbstractModule {
